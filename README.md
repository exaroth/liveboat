...
- Easily deployable to Github Pages - See [liveboat-github-runner](https://github.com/exaroth/liveboat-github-runner) template for details. Also includes [docker image](https://github.com/exaroth/liveboat/tree/develop/docker) for easy self hosting .
